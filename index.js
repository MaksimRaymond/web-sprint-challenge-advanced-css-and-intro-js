...
// function fixName(arr, index, name){
// arr[index].name = name;
// return arr;
// }
 ...
 *     (2) a number which is the desired index in the array.
 * removeArtist 
 *  and console.logs the length of the remaining dataset.
 * 
...
//   }
//   console.log(addArtist(artists, '20','Max', '1996-2020', 'Streaming', 'American', 'Maksim is a creator & thinker. His streams exude powerful characters and outstanding brashness and skill.' ))
...
// artists.map(artist => {if(artist.paintings > 100){newArr.push(artist.name)}})
// return newArr
// }
